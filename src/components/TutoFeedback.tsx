          ...
          >
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              <button
                ...
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg border text-sm font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                  pendingVote === 'down'
                    ? 'border-white/20 bg-red-500/15 text-red-300'
                    : 'border-white/15 bg-white/5 text-zinc-300 hover:border-white/20 hover:text-red-300'
                }`}
              >
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-green-400 to-purple-500 hover:bg-gradient-to-r from-green-400 to-purple-500 disabled:bg-zinc-700 disabled:cursor-not-allowed text-white font-semibold text-sm transition-colors"
              >
                {submitting && (
                  <Loader2
