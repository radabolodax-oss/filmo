...
const VipKeysManager: React.FC = () => {
  ...
  const getKeyStatus = (key: VipKey) => {
    ...
    if (isExpired) return { text: t('admin.expired'), class: 'bg-gradient-to-r from-green-400 to-purple-500' };
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex flex-col space-y-2 ml-4">
                      ...
                      <button
                        ...
                        className="px-3 py-1 bg-gradient-to-r from-green-400 to-purple-500 text-white text-sm rounded hover:bg-red-700"
                      >
                        {t('admin.delete')}
                      </button>
                    </div>
