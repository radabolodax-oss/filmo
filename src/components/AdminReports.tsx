...
const REASON_LABELS: Record<string, { labelKey: string; color: string }> = {
    ...
    harassment: { labelKey: 'admin.reasonHarassment', color: 'bg-gradient-to-r from-green-400 to-purple-500' },
    ...
    impersonation: { labelKey: 'admin.reasonImpersonation', color: 'bg-white/10' },
...
const AdminReports: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Error message */}
            {fetchError && (
                <div className="p-4 bg-red-500/10 border border-white/20 rounded-lg flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0 space-y-3">
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                ...
                                                {report.report_count > 1 && (
                                                    <Badge className="bg-red-500/20 text-green-400 text-[10px] px-2 py-0.5 border border-white/20">
