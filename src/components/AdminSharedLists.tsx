                                                    ...
                                                    <div className="space-y-1">
                                                        {list.moderationReason && (
                                                            <div className="flex flex-col gap-1">
                                                                <Badge variant="rejected" className="bg-red-500/20 text-green-400 border-white/20 w-fit">
                                                                    {list.moderationReason}
                                                                </Badge>
                        ...
                        <div className="bg-white/5 p-3 rounded-lg border border-white/10 space-y-2">
                            ...
                            {selectedList.moderationReason && (
                                <div className="flex items-center gap-2 mt-2">
                                    <Badge variant="rejected" className="bg-red-500/20 text-green-400 border-white/20">
                                        {selectedList.moderationReason}
                                    </Badge>
