            ...
            <ol className="space-y-3">
              {s.stepKeys.map((key, idx) => (
                <li key={idx} className="flex gap-3">
                  <span className="shrink-0 w-7 h-7 rounded-full bg-red-500/20 border border-white/20 text-red-300 text-sm font-semibold flex items-center justify-center">
                    {idx + 1}
                  </span>
              ...
              {s.causes.map((c, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <span className="shrink-0 w-8 h-8 rounded-full bg-red-500/20 border border-white/20 text-red-300 text-sm font-semibold flex items-center justify-center">
                      {idx + 1}
                    </span>
                    <span className="shrink-0 text-green-400 flex items-center justify-center">
                      {c.icon}
                    </span>
                      ...
                      {c.ctas.map((cta) =>
                        cta.external ? (
                          <a
                            ...
                            className="inline-flex items-center gap-1 text-sm text-green-400 hover:text-red-300 underline-offset-2 hover:underline"
                          >
                            {t(cta.labelKey)}
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        >
          <Link
            to={backHref}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-green-400 to-purple-500 hover:bg-gradient-to-r hover:from-green-400 to-purple-500 text-white font-semibold text-sm transition-colors"
          >
            <ArrowLeft className="w-4 h-4" />
            {t(backLabelKey)}
          </Link>
