            ...
            {isEmbedStream && hasActiveStream && !error && (
                <>
                    ...
                    <div className="absolute top-4 left-1/2 z-40 -translate-x-1/2 rounded-lg bg-black/60 px-4 py-2 text-center text-white shadow-lg backdrop-blur-sm">
                        <p className="text-xs uppercase tracking-[0.22em] text-green-400">Embed</p>
            ...
            <AnimatePresence>
                {showLiveTvSourcePicker && (
                    ...
                    >
                        ...
                        >
                        <div className="mb-4">
                            <p className="text-xs uppercase tracking-[0.22em] text-green-400">{t('liveTV.title')}</p>
                            ...
                            {sourceOptions.map((source) => {
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className="w-full rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-left transition-colors hover:border-white/20 hover:bg-red-500/10"
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 text-sm rounded border transition-colors ${
                                            source.index === selectedSourceIndex
                                                ? 'bg-gradient-to-r from-green-400 to-purple-500 border-white/20 text-white cursor-default'
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {!streams[currentStreamIndex]?._isEmbed && (
                                <button
                                    ...
                                    className="flex items-center gap-1.5 px-2 py-1 bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 rounded text-xs font-bold transition-colors cursor-pointer text-white"
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-3 py-2.5 rounded-lg text-sm transition-colors cursor-pointer ${
                                                        source.index === selectedSourceIndex ? 'bg-gradient-to-r from-green-400 to-purple-500 text-green-400' : 'text-gray-300 hover:bg-white/5'
                                                    }`}
                                                >
                                                    <div className="flex items-center gap-2">
                                                        {source.index === selectedSourceIndex && (
                                                            <span className="w-2 h-2 bg-gradient-to-r from-green-400 to-purple-500 rounded-full flex-shrink-0" />
                                                        )}
                            ...
                            {streams.map((stream, index) => (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2.5 rounded-lg text-sm transition-colors cursor-pointer flex items-center gap-2 ${
                                        index === currentStreamIndex ? 'bg-gradient-to-r from-green-400 to-purple-500 text-green-400' : 'text-gray-300 hover:bg-white/5'
                                    }`}
                                >
                                    {index === currentStreamIndex && (
                                        <span className="w-2 h-2 bg-gradient-to-r from-green-400 to-purple-500 rounded-full flex-shrink-0" />
                                    ...
                                    {index === currentStreamIndex && <span className="ml-auto text-green-400">✓</span>}
                                </button>
                            ))}
                                    </div>
                                </div>
