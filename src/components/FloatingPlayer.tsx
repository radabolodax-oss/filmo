          ...
          <div className="absolute bottom-0 left-0 right-0 p-3 space-y-2">
            ...
            <div className="w-full">
              <input
                ...
                onMouseDown={(e) => e.stopPropagation()}
                className="w-full h-1 bg-gray-600 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-gradient-to-r from-green-400 to-purple-500 [&::-webkit-slider-thumb]:cursor-pointer [&::-moz-range-thumb]:w-3 [&::-moz-range-thumb]:h-3 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-gradient-to-r from-green-400 to-purple-500 [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:cursor-pointer hover:[&::-webkit-slider-thumb]:bg-gradient-to-r from-green-400 to-purple-500 hover:[&::-moz-range-thumb]:bg-gradient-to-r from-green-400 to-purple-500"
                style={{
