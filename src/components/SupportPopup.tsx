  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 backdrop-blur-sm transition-opacity animate-fadeIn">
      <div className="bg-[#121212] p-8 rounded-2xl shadow-[0_0_30px_rgba(0,0,0,0.7)] max-w-md w-full mx-4 transform transition-all animate-support-popup border border-[#333] relative overflow-hidden">
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-gradient-to-br from-blue-600/20 rounded-full blur-3xl"></div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-center mb-6">
            <span className="w-16 h-16 bg-gradient-to-br from-blue-500 rounded-full flex items-center justify-center shadow-lg shadow-blue-500/20">
              <span className="text-3xl">🎬</span>
            </span>
          </div>
          
          <h2 className="text-2xl font-bold text-center mb-5 bg-gradient-to-r from-blue-400 bg-clip-text text-transparent">{t('support.likeOurSite')} ✨</h2>
          ...
          <div className="text-center mb-8 space-y-4">
            ...
            <div className="bg-gradient-to-r from-blue-900/40 p-4 rounded-xl border border-blue-500/20">
          ...
          <div className="flex justify-center">
            <button
              onClick={hidePopup}
              className="bg-gradient-to-r from-blue-600 hover:from-blue-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 shadow-lg shadow-blue-600/20 hover:shadow-blue-700/30 transform hover:-translate-y-1"
            >
              {t('common.understood')} 👍
            </button>
          </div>
