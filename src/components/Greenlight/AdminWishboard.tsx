...
const statusOptions = [
    ...
    { value: 'rejected', label: 'admin.statusRejected', color: 'text-green-400' },
];
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                {[
                    ...
                    { label: 'admin.rejectedPlural', value: stats.rejected, color: 'text-green-400' },
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <Badge variant={entry.role === 'admin' ? 'default' : 'secondary'} className={`text-xs ${
                                                    entry.role === 'admin' ? 'bg-red-500/20 text-green-400' : 'bg-blue-500/20 text-blue-400'
                                                }`}>
            ...
            <div className="flex flex-wrap items-center gap-4">
                ...
                <Button
                    ...
                    disabled={loading || batchChecking}
                    className="bg-red-500/20 hover:bg-red-500/30 text-green-400"
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        {result.available ? (
                                            ...
                                            <XCircle className="h-5 w-5 text-green-400 opacity-50" />
                                        )}
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                {result.available ? (
                                                    ...
                                                    <XCircle className="h-4 w-4 text-green-400 opacity-50" />
                                                )}
                    ...
                    {batchChecking ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <div className="bg-red-500/10 border border-white/20 rounded-lg p-3 text-center">
                                ...
                                {batchResults.filter(r => r.availableCategories === 0).length > 0 && (
                                    <div className="space-y-2">
                                        ...
                                        {batchResults.filter(r => r.availableCategories === 0).map((item) => (
                                            <div key={item.request.id} className="bg-red-500/10 border border-white/20 rounded-lg p-2 flex items-center gap-2">
                        ...
                        <div className="text-center py-10">
                            <ListChecks className="h-12 w-12 text-white mx-auto mb-4" />
