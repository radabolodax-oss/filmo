              ...
              <>
                      ...
                      {currentLinks.map((link, index) => (
                        <div key={index} className="flex items-center justify-between bg-gray-800 p-3 rounded-lg">
                          ...
                          <button
                            ...
                            className="ml-3 px-3 py-1 bg-gradient-to-r from-green-400 to-purple-500 text-white text-xs rounded hover:bg-red-700"
                          >
                      ...
                      <div key={index} className="flex space-x-2">
                        ...
                        {links.length > 1 && (
                          <button
                            ...
                            className="px-3 py-2 bg-gradient-to-r from-green-400 to-purple-500 text-white rounded-lg hover:bg-red-700"
                          >
                            -
                          </button>
                        )}
                ...
                <div className="flex space-x-4">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-gradient-to-r from-green-400 to-purple-500 text-white rounded-lg hover:bg-red-700 font-semibold"
                  >
                    ...
                    {downloadLinks.map((l, i) => (
                      <li key={i} className="flex items-center justify-between bg-gray-800 p-3 rounded">
                        ...
                        <button
                          ...
                          className="px-3 py-1 rounded bg-gradient-to-r from-green-400 to-purple-500 text-white text-sm"
                        >
                          Supprimer
                        </button>
                      </li>
