        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <div className="relative group">
            <img
              ...
              className="w-7 h-7 md:w-7 md:h-7 max-md:w-7 max-md:h-7 rounded-full object-cover border-2 border-transparent group-hover:border-white/20 transition-all duration-300 shadow-md"
              onError={(e) => {
                ...
                <>
                  <div className="px-5 py-4 border-b border-gray-700/50">
                    <div className="flex items-center gap-3">
                      <img 
                        src={profileImage} 
                        alt={t('header.profile')}
                        className="w-10 h-10 md:w-10 md:h-10 max-md:w-12 max-md:h-12 rounded-full object-cover border-2 border-white/20"
                        onError={(e) => {
                          e.currentTarget.src = 'https://as2.ftcdn.net/v2/jpg/05/89/93/27/1000_F_589932782_vQAEAZhHnq1QCGu5ikwrYaQD0Mmurm0N.webp';
                        }}
                      />
                  ...
                  <div className="px-4 py-3 border-t border-gray-700/50 space-y-3">
                    ...
                    <motion.div
                      ...
                      className={`flex items-center justify-center gap-2 w-full px-3 py-3 max-md:py-3
                        ${isVip
                          ...
                          : 'bg-gradient-to-r to-blue-600 text-white cursor-pointer hover:shadow-md'
                    ...
                    <motion.div 
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="flex items-center justify-center gap-2 w-full px-3 py-3 max-md:py-4 bg-gradient-to-r from-green-400 to-purple-500 hover:bg-gradient-to-r from-green-400 to-purple-500 text-white rounded-lg transition-colors cursor-pointer"
