    ...
    <div className="embla-slide flex-none relative w-[144px] md:w-[192px]">
      ...
      >
        ...
        {isHistory && 'currentEpisode' in item && item.currentEpisode && item.media_type === 'tv' && (
          <span className="absolute top-9 left-2 z-10 px-2 py-1 rounded-lg bg-black/75 text-[10px] font-semibold tracking-wider text-white/80">
        ...
        {isHistory && onRemoveItem ? (
          <button
            ...
            className="absolute top-2 right-2 z-20 p-2 rounded-full bg-black/65 hover:bg-black/85 active:scale-[0.85] text-white transition-[colors,transform] duration-150"
          >
