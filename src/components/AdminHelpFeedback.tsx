  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-2 text-sm text-zinc-300">
          <ThumbsDown className="w-4 h-4 text-green-400" />
      ...
      {error && (
        <div className="flex items-center gap-2 rounded-lg border border-white/20 bg-red-500/10 p-3 text-sm text-red-300">
