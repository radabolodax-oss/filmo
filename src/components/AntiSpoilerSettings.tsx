    ...
    <AnimatePresence mode="wait">
      {isOpen && !isClosing && (
        ...
        >
          ...
          {/* Master Toggle */}
          <div className="mb-6 p-4 bg-gradient-to-r from-red-900/20 to-orange-900/20 border border-white/20 rounded-xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`relative w-14 h-8 rounded-full transition-colors ${
                  settings.enabled ? 'bg-gradient-to-r from-green-400 to-purple-500' : 'bg-gray-600'
                }`}
              >
                <div
          ...
          <div className="flex gap-2 mb-6">
            ...
            />
              ...
              <div className="flex gap-3 mt-6 pt-6 border-t border-gray-700">
                ...
                <button
                  onClick={handleSave}
                  className="flex-1 px-4 py-3 bg-gradient-to-r from-green-400 to-purple-500 text-white rounded-xl hover:bg-red-700 transition-colors font-medium"
                >
                  {t('common.save')}
                </button>
              </div>
