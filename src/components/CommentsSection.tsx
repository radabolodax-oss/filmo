  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 transition-all duration-200 rounded-lg font-medium ${checked
        ? 'bg-red-600/20 text-green-400 border-2 border-red-500/50 hover:bg-red-600/30 hover:border-white/20'
    ...
    >
      ...
      {checked && (
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          className="w-2 h-2 bg-gradient-to-r from-green-400 to-purple-500 rounded-full"
        />
      )}
    </button>
  );
      ...
      <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
            ...
            {comment.is_admin === 1 && (
              <span className="px-1.5 sm:px-2 py-0.5 bg-gradient-to-r from-green-400 to-purple-500 text-white text-[10px] sm:text-xs rounded-full whitespace-nowrap">
                Admin
              </span>
            )}
            {comment.is_vip === 1 && (
            ...
            <div className="mt-2">
              ...
              {comment.is_spoiler === 1 && !revealedSpoilers.has(`comment-${comment.id}`) && (
                <motion.span
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="inline-flex items-center gap-1 mt-1 sm:mt-2 text-[10px] sm:text-xs text-green-400"
                >
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4 mt-3 sm:mt-4 flex-wrap">
            <button
              ...
              className={`flex items-center gap-1 transition-colors ${comment.userReaction ? 'text-green-400' : 'text-gray-400 hover:text-green-400'
                }`}
            ...
            {(isAdmin || (profileId && profileId === comment.profile_id)) && (
              <button
                ...
                className="text-xs sm:text-sm text-green-400 hover:text-green-400 transition-colors flex items-center gap-1"
              >
                      ...
                      {replyingTo.username && (
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-xs sm:text-sm text-gray-400">
                            {t('comments.replyTo')} <span className="text-green-400">@{replyingTo.username}</span>
                          </span>
                          <button
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                            ...
                            {reply.parent_reply_id && reply.reply_to_username && (
                              <span className="text-[10px] sm:text-xs text-green-400 truncate">
                            ...
                            <div className="mt-1">
                              ...
                              {reply.is_spoiler === 1 && !revealedSpoilers.has(`reply-${reply.id}`) && (
                                <motion.span
                                  ...
                                  animate={{ opacity: 1 }}
                                  exit={{ opacity: 0 }}
                                  className="inline-flex items-center gap-1 mt-1 text-[10px] sm:text-xs text-green-400"
                                >
                          ...
                          <div className="flex items-center gap-2 sm:gap-3 mt-1 sm:mt-2 flex-wrap">
                            <button
                              ...
                              className={`flex items-center gap-1 transition-colors ${reply.userReaction ? 'text-green-400' : 'text-gray-400 hover:text-green-400'
                                }`}
                              disabled={!isAuthenticated}
                            >
                            ...
                            {(isAdmin || (profileId && profileId === reply.profile_id)) && (
                              <button
                                ...
                                className="text-[10px] sm:text-xs text-green-400 hover:text-green-400 transition-colors flex items-center gap-1"
                              >
                ...
                {repliesHasMore && (
                  ...
                  >
                    <button
                      ...
                      className="text-xs sm:text-sm text-gray-400 hover:text-green-400 transition-colors px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-gray-700/50 w-full sm:w-auto text-center"
                    >
        ...
        >
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              {commentLimits && !commentLimits.isAdmin && (
                <div className="mt-3 flex flex-wrap gap-3 text-xs sm:text-sm items-center">
                  ...
                  <div className={`px-3 py-1.5 rounded-lg border ${commentLimits.movieLimit !== null && commentLimits.movieCount >= commentLimits.movieLimit
                    ? 'bg-red-500/10 border-red-500/30 text-green-400'
              ...
              {commentLimits && commentLimits.isAdmin && (
                <div className="mt-3 flex flex-wrap gap-3 text-xs sm:text-sm items-center">
                  <div className="px-3 py-1.5 rounded-lg border bg-red-600/20 border-red-500/30 text-green-400 font-semibold">
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <motion.button
                  ...
                  className="flex-1 px-4 py-2.5 bg-gradient-to-r from-green-400 to-purple-500 hover:bg-gradient-to-r hover:from-green-400 to-purple-500 text-white rounded-xl font-medium transition-colors text-sm flex items-center justify-center gap-2"
                >
                  <Trash2 className="w-4 h-4" />
                  {t('common.delete')}
                </motion.button>
