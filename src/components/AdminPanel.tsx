      ...
      >
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            {error && <p className="text-green-400 text-center">{error}</p>}
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-green-400 to-purple-500 text-white p-3 rounded-lg hover:bg-red-700 transition-colors"
            >
              {t('admin.connection')}
            </button>
          </form>
        ...
        <div className="bg-gray-800 p-6 rounded-lg mb-8">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="bg-gradient-to-r from-green-400 to-purple-500 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors flex items-center gap-2"
            >
