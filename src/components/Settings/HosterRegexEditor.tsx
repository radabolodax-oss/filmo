      ...
      <div className="space-y-1 pt-1">
        <div className="flex items-center gap-2">
          <Input
            ...
            className={localError ? 'border-white/20' : ''}
          />
        ...
        {localError && <p className="text-xs text-green-400">{localError}</p>}
      </div>
    );
  }
                        ...
                        <div className="space-y-1 pt-1">
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              className={newPatternError ? 'border-white/20' : ''}
                            />
                            <Button
                              size="sm"
                          ...
                          {newPatternError && (
                            <p className="text-xs text-green-400">{regexErrorMessage(newPatternError)}</p>
                          )}
                        </div>
                      ) : (
                        <Button
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <Input
            ...
            className={customError && customError.kind !== 'nameRequired' ? 'border-white/20' : ''}
          />
          {customError && <p className="text-xs text-green-400">{customErrorMessage(customError)}</p>}
