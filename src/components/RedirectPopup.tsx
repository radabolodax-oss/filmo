      ...
      {isOpen && !isClosing && (
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className="bg-gray-900 rounded-2xl p-6 max-w-md w-full border-2 border-white/20"
          >
            {/* Header */}
            ...
            <div className="text-center">
              <div className="mb-6">
                ...
                <div className="bg-red-600/20 border-2 border-white/20 rounded-lg p-4 mb-4">
