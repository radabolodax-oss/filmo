          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
              ...
              <div className="flex flex-row md:flex-col gap-3 w-full md:w-auto md:min-w-[180px]">
                ...
                <div className="flex-1 md:flex-none flex items-center gap-3 p-3 rounded-xl bg-red-500/10 border border-white/20">
                  <div className="p-1.5 rounded-lg bg-red-500/20">
                    <Minus className="w-4 h-4 text-green-400" strokeWidth={3} />
                  </div>
                  <div>
