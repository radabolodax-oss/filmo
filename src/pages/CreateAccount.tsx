...
const CreateAccount: React.FC<CreateAccountProps> = ({ mode = 'create' }) => {
  ...
  const renderStep1 = () => (
    ...
    >
      <div className="bg-gradient-to-br from-blue-500/10 border border-blue-500/30 rounded-xl p-6">
      ...
      <div className="text-center">
        ...
        <div className="relative inline-block">
          <motion.div
            ...
            className="w-24 h-24 rounded-full overflow-hidden border-2 border-white/20 cursor-pointer"
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={() => setShowAvatarModal(true)}
            className="absolute bottom-0 right-0 p-2 bg-gradient-to-r from-green-400 to-purple-500 rounded-full text-white hover:bg-red-700 transition-colors"
          >
            ...
            <div key={step.id} className="flex items-center">
              ...
              {index < steps.length - 1 && (
                <div className={`w-8 h-0.5 mx-2 transition-all duration-300 ${
                  currentStep > step.id ? 'bg-gradient-to-r from-green-400 to-purple-500' : 'bg-gray-700'
                }`} />
              )}
            </div>
          ))}
