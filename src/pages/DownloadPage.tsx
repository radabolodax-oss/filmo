            ...
            {displaySeasons.map((season) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 text-sm transition-colors duration-150 ${
                  isDarkiWorld 
                    ? (selectedDarkiWorldSeason?.id === (season as DarkiWorldSeason).id ? 'bg-gradient-to-r from-green-400 to-purple-500 text-green-400' : 'text-gray-200 hover:bg-gray-700')
                    : (selectedSeason === (season as Season).season_number ? 'bg-gradient-to-r from-green-400 to-purple-500 text-green-400' : 'text-gray-200 hover:bg-gray-700')
                }`}
              >
                {isDarkiWorld
          ...
          >
            {displayEpisodes.map((episode) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 text-sm transition-colors duration-150 ${
                  isDarkiWorld 
                    ? (selectedDarkiWorldEpisode?.id === (episode as DarkiWorldEpisode).id ? 'bg-gradient-to-r from-green-400 to-purple-500 text-green-400' : 'text-gray-200 hover:bg-gray-700')
                    : (selectedEpisode === (episode as Episode).episode_number ? 'bg-gradient-to-r from-green-400 to-purple-500 text-green-400' : 'text-gray-200 hover:bg-gray-700')
                }`}
              >
                {isDarkiWorld
              ...
              {selectedLink && (
                 <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-gray-800/50 rounded-xl border border-gray-700/50">
                  ...
                  {isDecoding ? (
                    ...
                    <div className="flex flex-col text-green-400 text-sm sm:text-base">
                      <div className="flex items-center">
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="flex flex-col items-center justify-center">
          <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-white/20 mb-4"></div>
              ...
              <div className="bg-gray-800/50 rounded-xl p-4 sm:p-6 border border-gray-700/50">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="relative">
                          <input
                            ...
                            min="1"
                            className="w-32 px-3 py-2 pr-8 bg-white/5 border border-gray-700/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-white/20 transition-colors [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                            onKeyPress={(e) => {
                              if (e.key === 'Enter') {
                ...
                <div className="mt-4 sm:mt-6">
                  <button
                    ...
                    disabled={loadingLinks}
                    className="w-full flex items-center justify-center gap-2 px-4 sm:px-6 py-3 bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 disabled:bg-gray-600 rounded-xl transition-colors text-sm sm:text-base"
                  >
                    {loadingLinks ? (
                  ...
                  <div className="mt-4 sm:mt-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      {sortDownloadLinks(downloadLinks).map((link) => (
                        <div
                          key={link.id}
                          className="p-3 sm:p-4 bg-gray-800/50 rounded-xl border border-gray-700/50 cursor-pointer hover:border-white/20 transition-colors duration-200"
                ...
                {error && (
                  <div className="mt-4 p-3 sm:p-4 bg-red-900/20 border border-white/20 rounded-xl backdrop-blur-sm">
