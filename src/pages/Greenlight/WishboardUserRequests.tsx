                                            ...
                                            {request.notes && request.notes.length > 0 && (
                                                <div className="mt-4" onClick={(e) => e.stopPropagation()}>
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 text-sm text-green-400 hover:text-red-300 transition-colors"
                                                    >
                                        ...
                                        {request.has_voted && (
                                            <div onClick={(e) => e.stopPropagation()}>
                                                <Button
                                                    ...
                                                    className="bg-red-500/10 text-green-400 hover:bg-red-500/20 hover:text-green-400 border-white/20"
                                                >
