    ...
    return (
      ...
      >
        <div className="relative aspect-video rounded-xl overflow-hidden bg-white/[0.02] border border-white/[0.04] group-hover:border-white/10 transition-all duration-300 group-hover:bg-white/[0.04]">
          ...
          <div className="absolute top-2 left-2 flex items-center gap-1 px-1.5 py-0.5 bg-gradient-to-r from-green-400 to-purple-500 rounded text-[9px] font-bold tracking-wide uppercase">
  ...
  const renderIptvCategoryOption = (category: IptvCategory) => {
    ...
    return (
      ...
      >
        ...
        >
          <span className={cn('truncate pr-2', active ? 'text-green-400' : 'text-white/70 group-hover:text-white/90')}>
          ...
          {!isNoImage && channel.poster ? (
            ...
            <div className={cn(
              ...
              {isEventCard ? (
                ...
                <>
                  <Tv className={cn('w-6 h-6 mb-1', isSosplay ? 'text-emerald-500 opacity-40' : isLivetv ? 'text-amber-500 opacity-40' : isWiflix ? 'text-green-400 opacity-40' : 'text-white opacity-10')} />
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="p-2.5 bg-red-500/10 rounded-xl border border-white/20">
                    <Tv className="w-6 h-6 text-green-400" />
                  </div>
                  <div className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-gradient-to-r from-green-400 to-purple-500 rounded-full animate-pulse" />
                </div>
                <div>
                  ...
                  return (
                    <motion.button
                      ...
                      className={cn(
                        ...
                        isActive
                          ? 'bg-red-500/15 text-green-400 border-white/20 shadow-sm shadow-red-500/10'
                          : isLocked
                    ...
                    <>
                      <button
                        ...
                        className={cn(
                          ...
                          iptvCategoryDropdownOpen
                            ? 'bg-white/[0.06] border-white/20 ring-1 ring-red-500/10'
                            : 'bg-white/[0.03] border-white/[0.06] hover:bg-white/[0.05] hover:border-white/10'
                        )}
                      >
                        <i className="bi bi-globe text-green-400 shrink-0" />
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      active
                        ? 'bg-red-500/15 text-green-400 border-white/20'
        ...
        {error && !loadingCatalogs && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center py-24 gap-4">
            <div className="p-4 rounded-2xl bg-red-500/[0.06] border border-white/20">
              <Wifi className="w-8 h-8 text-green-400 opacity-60" />
            </div>
