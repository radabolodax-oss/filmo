            ...
            {roomInfo && (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-red-500/10 rounded-lg shrink-0 text-green-400">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="roomCode" className="block text-sm font-medium mb-2 text-white/80 flex items-center gap-2">
                  <Hash className="h-4 w-4 text-green-400" /> {t('watchParty.watchPartyCode')}
                </label>
                <input
                  type="text"
                  id="roomCode"
              ...
              <div>
                <label htmlFor="nickname" className="block text-sm font-medium mb-2 text-white/80 flex items-center gap-2">
                  <User className="h-4 w-4 text-green-400" /> {t('watchParty.yourPseudo')}
                </label>
                <input
                  type="text"
                  id="nickname"
              ...
              <Button
                ...
                className={`
                  ...
                  ${isJoining || !roomCode || !nickname ? 'bg-white/10 text-white/50 cursor-not-allowed' : 'bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 text-white border-0'}
                `}
              >
                {isJoining ? (
