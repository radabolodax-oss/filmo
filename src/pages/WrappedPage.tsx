                ...
                {timeUnits.slice(0, finalUnitIndex + 1).map((_, idx) => (
                    <motion.div
                        ...
                        className={`w-2 h-2 rounded-full transition-colors duration-300 ${
                            idx <= currentUnitIndex ? 'bg-white/10' : 'bg-white/20'
                        }`}
...
const WrappedStandaloneShell: React.FC<{
    mode: 'combined' | 'static' | 'animated';
    children: React.ReactNode;
}> = ({ mode, children }) => (
    <div className="fixed inset-0 z-50 bg-black">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_24%,transparent,transparent_52%)]" />
        <div
    ...
    <WrappedCenteredSlide contentClassName="max-w-4xl">
        ...
        >
            <h1 className="mb-3 px-2 text-3xl font-black leading-tight sm:text-4xl md:text-5xl">
                <ShinyText text={slide.title} speed={2} color="#ffffff" shineColor="#ffffff" className="max-w-full" />
            </h1>
        </motion.div>
        ...
        <motion.p
            ...
            className="mb-5 max-w-2xl text-base font-medium text-white sm:text-lg md:text-xl"
        >
            {slide.subtitle}
        </motion.p>
        ...
        >
            ...
            >
                ...
                <motion.p
                    ...
                    animate={{ opacity: 1 }}
                    transition={{ delay: 8 }}
                    className="mt-4 text-xs text-white sm:text-sm"
                >
    ...
    <WrappedCenteredSlide contentClassName="max-w-4xl">
        ...
        >
            <motion.div
                ...
                className="relative w-28 h-28 md:w-36 md:h-36 rounded-full bg-gradient-to-br from-fuchsia-500 via-black to-violet-600 flex items-center justify-center"
            >
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <motion.button
                        ...
                        className="flex items-center justify-center gap-2 rounded-2xl border border-fuchsia-400/25 bg-gradient-to-r from-fuchsia-500/20 px-4 py-3 text-sm font-semibold text-white disabled:opacity-60"
                    >
...
const slideBackgrounds: Record<string, { color: string; gradient: string }> = {
    intro: { color: 'transparent', gradient: ' via-transparent to-transparent' },
                ...
                <div className="flex flex-1 flex-col items-center justify-start pb-6 text-center md:justify-center">
                    ...
                    >
                        <div className="relative">
                            <div
                                ...
                                style={{ background: 'radial-gradient(circle, rgba(0,0,0,0) 0%, transparent 70%)' }}
                            />
                    ...
                    >
                        <button
                            ...
                            className="flex min-h-[48px] w-full items-center justify-center gap-2 rounded-xl bg-white/10 px-6 py-3 text-white transition-colors hover:bg-white/10 sm:min-w-[180px] sm:w-auto"
                        >
                ...
                <div className="flex flex-1 flex-col items-center justify-start pb-6 text-center md:justify-center">
                    ...
                    >
                        <div className="relative">
                            ...
                            />
                            <ShieldOff className="relative h-16 w-16 text-green-400 sm:h-20 sm:w-20" />
                        </div>
                    </motion.div>
                    ...
                    <motion.button
                        ...
                        className="flex min-h-[48px] w-full items-center justify-center gap-2 rounded-xl bg-white/10 px-6 py-3 text-white transition-colors hover:bg-white/10 sm:w-auto"
                    >
    ...
    if (loading) {
        return (
            <div className="fixed inset-0 z-50 bg-black flex items-center justify-center">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,transparent,transparent_50%)]" />
                <div className="flex flex-col items-center justify-center w-full h-full">
                    ...
                    >
                        <motion.div
                            ...
                            className="w-20 h-20 mx-auto mb-6 rounded-full border-4 border-white/20 border-t-white/40"
                        />
                        <h2 className="text-2xl font-bold text-white mb-2">{t('wrapped.preparingWrapped')}</h2>
                        <p className="text-white">{t('wrapped.analyzingYear')}</p>
                    </motion.div>
                </div>
            </div>
        );
        ...
        return (
            <WrappedStandaloneShell mode={bgMode}>
                ...
                <div className="flex flex-1 flex-col items-center justify-start pb-6 text-center md:justify-center">
                    ...
                    >
                        <ShinyText text={`Wrapped ${year}`} speed={2} color="#ffffff" shineColor="#ffffff" className="" />
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.4 }}
                        className="mb-3 max-w-xl text-lg font-semibold text-white sm:text-xl md:text-2xl"
                    >
                    ...
                    >
                        ...
                        >
                            ...
                            {wrappedProgress && (
                                <div className="mb-6 rounded-[1.5rem] border border-white/10 bg-white/5 p-4 sm:p-5">
                                    <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                                        ...
                                        <div className="inline-flex self-start rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-semibold text-white">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={() => navigate('/')}
                                className="w-full rounded-full bg-gradient-to-r to-fuchsia-500 px-6 py-3.5 text-sm font-bold text-white transition-shadow hover:shadow-lg sm:w-auto"
                            >
