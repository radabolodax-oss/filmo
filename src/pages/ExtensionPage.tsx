...
const supportedHostersData = [
  ...
  { name: 'Vidzy', descKey: 'extension.hosterVidzyDesc', color: '#ffffff' },
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-green-400">{t('extension.withoutExtension')}</h3>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5 border border-white/20">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-xs text-green-400">{t('extension.diagramServerRequest')}</span>
                          <div className="h-px flex-1 bg-red-500/30" />
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-white/5 border border-white/20">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-green-400 mt-1">{t('extension.diagramDiffIP')}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-red-500/10 border border-white/20">
