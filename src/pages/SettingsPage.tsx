    ...
    <div className="mb-6 rounded-xl border border-white/10 bg-white/5 p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="text-sm text-green-400 hover:text-red-300 disabled:text-gray-600 flex items-center gap-1.5"
        >
...
const SettingsPage: React.FC = () => {
  ...
  const renderToggle = (value: boolean, onToggle: () => void, color: string = 'red') => {
    const bgActive = color === 'blue' ? 'bg-blue-500' : color === 'purple' ? 'bg-white/10' : color === 'green' ? 'bg-green-500' : color === 'indigo' ? 'bg-indigo-500' : 'bg-gradient-to-r from-green-400 to-purple-500';
    return (
      <button
        onClick={onToggle}
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <div className="lg:hidden flex items-center gap-4 p-4 border-b border-gray-800/60 bg-[#0a0a0f]">
        ...
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-xl bg-gradient-to-br from-red-600/20 to-orange-600/20 border border-white/20">
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute inset-0 bg-gradient-to-r from-green-400 to-purple-500 border border-white/20 rounded-xl shadow-sm shadow-red-600/5 pointer-events-none"
                          transition={{ type: 'spring', bounce: 0.18, duration: 0.45 }}
                        />
                      )}
                      <Icon className={`relative z-10 w-4 h-4 flex-shrink-0 ${isActive ? 'text-green-400' : 'text-gray-500'}`} />
                  ...
                  {visibleSections.map(({ id, labelKey, icon: Icon }) => {
                    ...
                    return (
                      <button
                        key={id}
                        onClick={() => scrollToSection(id)}
                        className={`flex w-[92px] flex-shrink-0 flex-col items-center justify-center gap-1 rounded-lg px-3 py-1.5 text-center transition-colors ${isActive ? 'text-green-400' : 'text-gray-500'
                          }`}
                      >
          ...
          <div ref={contentRef} className="flex-1 min-w-0 space-y-12 pb-24 lg:pb-8 lg:ml-72">
            ...
            <section id="appearance" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 rounded-xl bg-gradient-to-br to-pink-600/20 border border-white/20">
                    ...
                    {([
                      ...
                      <button
                        ...
                        className={`flex-1 min-w-[100px] p-3 rounded-xl text-left transition-colors border ${bgMode === opt.value
                          ? 'bg-gradient-to-r from-green-400 to-purple-500 border-white/20 text-white'
                          : 'bg-gray-700/20 border-gray-700/40 text-gray-400 hover:bg-gray-700/40 hover:text-white'
                        }`}
                      >
                        ...
                        <span
                          ...
                          style={{
                            background: bgAccent === 'custom'
                              ? bgAccentCustomHex
                              : 'conic-gradient(from 0deg, #ef4444, #f59e0b, #eab308, #22c55e, #06b6d4, #6366f1, #ffffff, #ec4899, #ef4444)',
                          }}
                        />
                              ...
                              {[
                                ...
                                <button
                                  ...
                                  className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${screensaverTimeout === opt.value
                                    ? 'bg-gradient-to-r from-green-400 to-purple-500 text-white shadow-lg shadow-red-600/20'
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                {!isCurrentSession && (
                                  <motion.button
                                    ...
                                    className="p-2 hover:bg-red-500/15 rounded-lg transition-colors text-gray-500 hover:text-green-400"
                      ...
                      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        ...
                        <button
                          ...
                          className={`px-4 py-2.5 rounded-xl text-sm font-medium transition-colors md:min-w-[180px] ${
                            status.linked
                              ? 'bg-red-500/10 text-red-300 border border-white/20 hover:bg-red-500/15'
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3 mb-4">
                        <div className="p-2.5 rounded-xl bg-red-500/10 border border-white/20">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="flex-1 px-4 py-2.5 rounded-xl bg-gradient-to-r from-green-400 to-purple-500 text-white hover:bg-gradient-to-r hover:from-green-400 to-purple-500 transition-colors text-sm font-medium"
                        >
            ...
            <section id="extractions" data-settings-section="extractors" className="scroll-mt-24">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 rounded-xl bg-gradient-to-br from-indigo-600/20 border border-indigo-500/20">
          ...
          {linkModal && !isClosingLinkModal && (
            ...
            >
              ...
              >
                ...
                {linkActionError && (
                  <div className="mb-4 px-4 py-3 rounded-xl bg-red-500/10 border border-white/20 text-sm text-red-300">
                    {linkActionError}
                  </div>
                )}
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-2.5 rounded-xl text-sm font-medium transition-colors ${
                      linkModal.action === 'link'
                        ...
                        : 'bg-gradient-to-r from-green-400 to-purple-500 text-white hover:bg-gradient-to-r hover:from-green-400 to-purple-500'
            ...
            >
              ...
              >
                <div className="flex items-start gap-4 mb-5">
                  <div className="shrink-0 p-3 rounded-xl bg-gradient-to-br from-red-600/20 to-orange-600/20 border border-white/20">
                ...
                <div className="flex items-center justify-end gap-2 pt-4 border-t border-white/5">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 text-white transition-colors"
                  >
              ...
              >
                ...
                >
                  ...
                  <div className="flex justify-end">
                    <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 text-white transition-colors" onClick={handleCloseIdPopup}>
                      {t('common.understood')}
                    </button>
                  </div>
                </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="flex justify-end">
                    <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 text-white transition-colors" onClick={handleCloseLocalStoragePopup}>
                      {t('common.close')}
                    </button>
                  </div>
                </div>
              ...
              >
                ...
                >
                  ...
                  <div className="mt-4 flex justify-end">
                    <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 text-white transition-colors" onClick={handleCloseNonSyncablePopup}>
                      {t('common.close')}
                    </button>
                  </div>
                </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {importError && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-red-900/30 border border-white/20 rounded-lg p-4 mb-4">
