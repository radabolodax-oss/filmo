...
import { ArrowLeft, Clock, Film, Tv2, Users, Award, Loader2, AlertCircle, Crown, Play } from 'lucide-react';
...
const CSA_INFO: Record<string, { label: string; color: string; desc: string }> = {
  ...
  '16': { label: '-16 ans', color: 'bg-gradient-to-r from-green-400 to-purple-500', desc: 'Déconseillé aux moins de 16 ans' },
