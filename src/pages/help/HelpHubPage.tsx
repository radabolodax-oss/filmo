...
const ACCENT_BORDER: Record<TutoAccent, string> = {
  red: 'border-white/20 group-hover:border-white/20',
  ...
  purple: 'border-white/20 group-hover:border-white/20',
};
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <div className="relative max-w-xl mx-auto">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-white/[0.04] pl-10 pr-10 py-3 text-white placeholder:text-zinc-500 outline-none focus:border-white/20 focus:bg-white/[0.06] transition-colors"
            />
            {query && (
              <button
                type="button"
