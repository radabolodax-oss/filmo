          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <AnimatedBorderCard
                ...
                tabIndex={0}
              >
                <Ticket className="h-4 w-4 mr-2 text-white group-hover:text-green-400 transition-colors" />
      ...
      <div className="container px-6 md:px-10 py-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/5">
              ...
              <p className="text-sm text-white/60">
                {t('watchParty.vipPlayersOnlyDesc')} <Link to="/vip" className="text-green-400 hover:text-red-300 hover:underline">{t('watchParty.vipPageLabel')}</Link>
              </p>
            </div>
          </div>
        </motion.div>
        ...
        {isLoading ? (
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="bg-red-500/10 border border-white/20 rounded-lg p-6 text-center"
          >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-4 flex items-center justify-between gap-3">
                        ...
                        <Button
                          ...
                          size="sm"
                          className="bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 text-white border-0"
                        >
