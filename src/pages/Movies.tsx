...
const Movies: React.FC = () => {
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="bg-gradient-to-r from-green-400 to-purple-500 text-green-400 px-6 py-4 rounded-lg">
          {error}
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-black text-white -mt-[302px]">
      ...
      {/* Content Sections */}
      <div className="pb-3 mt-0 relative z-[20]">
        {/* Trouver par genre avec titre standardisé - MAINTENANT EN PREMIER */}
        <div className="w-full bg-black py-2 relative px-4 md:px-8">
          <EmblaCarouselGenres
            title={genresTitle}
            items={genreItems}
          />
