          ...
          <div className="p-6 md:p-8">
            ...
            <div className="flex flex-col md:flex-row gap-8 mb-8">
              ...
              <div className="md:w-2/3 space-y-6">
                ...
                <div className="p-4 bg-red-500/10 border border-white/20 rounded-lg flex gap-3 items-start">
                ...
                <form onSubmit={handleCreateParty} className="space-y-6">
                      ...
                      <div className="flex bg-white/5 p-1 rounded-lg border border-white/10">
                        <button
                          ...
                          className={`flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-md text-sm font-medium transition-colors ${!isPublic
                            ? 'bg-gradient-to-r from-green-400 to-purple-500 text-white shadow-lg shadow-red-500/20'
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      <button
                        ...
                        className={`rounded-xl border p-4 text-left transition-all ${syncMode === 'classic'
                          ? 'border-white/20 bg-red-500/10 shadow-lg shadow-red-500/10'
                  ...
                  {sourceGroups.length > 0 && (
                    <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                      ...
                      <div className="mb-4 rounded-xl border border-white/20 bg-red-500/10 p-3">
                        ...
                        <div className="mt-2 flex items-start justify-between gap-3">
                          ...
                          <Badge variant="default" className="border border-white/20 bg-red-500/15 text-red-200 hover:bg-red-500/20">
                  ...
                  {error && (
                    <div className="p-3 bg-red-500/10 border border-white/20 rounded-lg text-center">
                  ...
                  <Button
                    ...
                    className="w-full h-12 text-base bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 text-white border-0 transition-all shadow-lg hover:shadow-red-600/20 hover:scale-[1.02]"
                  >
                    {isCreating ? (
