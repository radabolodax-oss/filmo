  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-white/20"></div>
      </div>
    );
  }
    ...
    <div className="pt-20 pb-16 bg-black text-white min-h-screen">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-12">
          ...
          >
            <div className="rounded-xl overflow-hidden shadow-2xl bg-gradient-to-br to-blue-900/50 p-1">
              <img
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b to-blue-600 z-0 transform -translate-x-1/2 opacity-75"></div>
              ...
              {years.map((year, idx) => (
                <div key={year} className="relative">
                  ...
                  <motion.div 
                    ...
                    className="sticky top-32 left-1/2 w-16 h-16 rounded-full bg-gradient-to-r to-blue-600 flex items-center justify-center z-10 transform -translate-x-1/2 mb-16 shadow-lg"
                  >
