                  ...
                  <div key={request.title} className="rounded-3xl border border-white/10 bg-white/5 p-5">
                    ...
                    <div className="mt-4 flex flex-wrap gap-3">
                      <button
                        ...
                        className="rounded-xl bg-gradient-to-r from-green-400 to-purple-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-gradient-to-r hover:from-green-400 to-purple-500"
                      >
