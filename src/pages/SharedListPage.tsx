...
const SharedListPage: React.FC = () => {
  ...
  const getTypeBadge = (type: string) => {
    switch (type) {
      ...
      case 'collection': return { label: t('common.collection'), color: 'bg-white/10' };
      ...
      <div className="min-h-screen bg-black text-white">
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-10">
          ...
          <div className="max-w-2xl mx-auto text-center mt-20">
            ...
            >
              <List className="w-14 h-14 text-white opacity-50 mx-auto mb-4" />
              ...
              <Link to="/">
                <Button className="bg-white/10 hover:bg-white/10 text-white px-6 h-11 gap-2">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          >
            ...
            >
              <div className="relative">
                <div className="w-12 h-12 rounded-full overflow-hidden ring-2 ring-white/20 ring-offset-2 ring-offset-black">
                  <img
                    src={listData.avatar}
                ...
                <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-white/10 rounded-full flex items-center justify-center ring-2 ring-black">
            ...
            <h1 className="text-3xl md:text-5xl font-black tracking-tight mb-4 pb-2">
              <ShinyText text={listData.listName} speed={3} color="#ffffff" shineColor="#ffffff" className="block py-2 leading-tight" />
            </h1>
          ...
          >
            ...
            {stats.collections > 0 && (
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/20 bg-white/10">
                ...
                <span className="text-white text-sm font-medium">{t('lists.collectionCount', { count: stats.collections })}</span>
              </div>
            )}
          </motion.div>
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/10 transition-all text-sm text-white/60 hover:text-white"
            >
          ...
          {loadingEnrich && enrichedItems.length === 0 ? (
            <div className="flex items-center justify-center py-16">
              <div className="flex flex-col items-center gap-3">
                <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-white/20"></div>
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                <List className="w-14 h-14 text-white opacity-30 mx-auto mb-4" />
                ...
                return (
                  ...
                  >
                    <Link to={getItemLink(item)}>
                      <div className="relative rounded-xl overflow-hidden bg-white/5 border border-white/10 group-hover:border-white/20 transition-colors shadow-lg">
                        {canWatchlistMedia && (
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            <div className="absolute bottom-0 left-0 right-0 p-3 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                              ...
                              {(item as any).genres && (item as any).genres.length > 0 && (
                                <p className="text-white text-[10px] mt-1 line-clamp-1">
        ...
        >
          <AnimatedBorderCard
            ...
            className="p-8 backdrop-blur-sm"
          >
            <Share2 className="w-10 h-10 text-white mx-auto mb-4" />
