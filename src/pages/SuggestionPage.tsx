        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-4">
              <ShinyText text={t('suggestionPage.findYourNext')} speed={3} color="#ffffff" shineColor="#ffffff" className="block" />
              <ShinyText text={t('suggestionPage.obsession')} speed={2} color="#ffffff" shineColor="#ffffff" className="block mt-2" />
            </h1>
            <BlurText
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="relative w-16 h-16 border-3 border-white/20 border-t-white/40 rounded-full"
              />
            </div>
            <BlurText
            ...
            <motion.div 
              ...
              className="h-1 bg-gradient-to-r via-pink-500 rounded-full mt-6 max-w-xs"
            />
          </motion.div>
        )}
                ...
                <div className="w-full md:w-2/3 flex flex-col">
                  ...
                  >
                    <Link to={suggestion.media_type === 'movie' ? `/movie/${encodeId(suggestion.id)}` : `/tv/${encodeId(suggestion.id)}`}>
                      <Button className="bg-white/10 hover:bg-white/10 text-white px-6 h-11">
