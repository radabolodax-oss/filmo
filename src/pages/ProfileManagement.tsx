...
const ProfileManagement: React.FC = () => {
  ...
  const ageRestrictionOptions = [
    ...
    { value: 18, label: '18+', color: 'text-green-400' },
  ];
                ...
                >
                  <div className="relative group">
                    ...
                    {(profile.ageRestriction ?? 0) > 0 && (
                      <div className="absolute -bottom-0.5 -right-0.5 xs:-bottom-1 xs:-right-1 bg-gradient-to-r from-green-400 to-purple-500 rounded-full px-1 xs:px-1.5 py-0.5 z-10 flex items-center gap-0.5">
                  ...
                  <div className="mt-2 xs:mt-3 sm:mt-4 w-full max-w-xs">
                    ...
                    {(profile.ageRestriction ?? 0) > 0 && (
                      <p className="text-[10px] xs:text-xs text-green-400 text-center mt-0.5 flex items-center justify-center gap-1">
              ...
              {profiles.length < 5 && (
                ...
                >
                  <div className="relative">
                    <div className="w-20 h-20 xs:w-24 xs:h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40 rounded-lg border-2 border-dashed border-gray-600 flex items-center justify-center group-hover:border-white/20 transition-colors cursor-pointer"
                      onClick={handleOpenCreate}
                    >
                      <Plus className="w-6 h-6 xs:w-8 xs:h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-gray-400 group-hover:text-green-400 transition-colors" />
                    </div>
                  </div>
            ...
            >
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 text-white rounded transition-colors"
                >
                  {t('common.delete')}
                </button>
              </div>
               ...
               <div className="text-center">
                 ...
                 <div className="flex gap-3">
                   ...
                   <motion.button
                     ...
                     className="flex-1 px-4 py-2 border border-white/20 rounded-lg hover:border-white/20 transition-colors"
                   >
                     {t('common.delete')}
                   </motion.button>
                 </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="relative">
                    <motion.div
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-28 h-28 sm:w-32 sm:h-32 rounded-full overflow-hidden cursor-pointer border-2 border-gray-600 hover:border-white/20 transition-colors"
                    ...
                    {modalAgeRestriction > 0 && (
                      <div className="absolute -bottom-2 -right-2 bg-gradient-to-r from-green-400 to-purple-500 rounded-full px-2.5 py-1 z-10 flex items-center gap-1 shadow-lg shadow-red-600/40">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6">
                ...
                {!isCreating && (
                  <motion.button
                    ...
                    className="flex-1 px-4 py-2 border border-white/20 rounded-lg hover:border-white/20 disabled:border-gray-600 disabled:cursor-not-allowed transition-colors"
                  >
                    {t('common.delete')}
                  </motion.button>
                )}
                <motion.button
                  ...
                  className="flex-1 px-4 py-2 bg-gradient-to-r from-green-400 to-purple-500 hover:bg-red-700 disabled:bg-gray-600 text-white rounded-lg transition-colors"
                >
